...
import GameStompClient from './model/gameStompClient.ts'
import TrainLocationMessage from './model/trainLocationMessage.ts'
import TrainManager from './trainManager.ts'
...
export default class STOMPManager {
  ...
  createClientForGame(game: unknown, port: string) {
